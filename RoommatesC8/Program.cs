            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Delete a room"):
                        ...
                        Console.WriteLine($"Room {selectedRoomIdToDelete} has been successfully deleted");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
                    ...
                    case ("Delete a chore"):
                        ...
                        Console.WriteLine($"Chore {selectedChoreIdToDelete} has been successfully deleted");
                        Console.Write("Press any key to continue");
                        Console.ReadKey();
                        break;
